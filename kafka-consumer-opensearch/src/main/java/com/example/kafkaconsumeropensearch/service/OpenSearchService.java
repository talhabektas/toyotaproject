...
public class OpenSearchService {
    ...
    public void init() {
        try {
            ...
            if (!exists) {
                ...
                timestamp.put("format", "yyyy-MM-dd'T'HH:mm:ss||yyyy-MM-dd'T'HH:mm:ss.SSS||strict_date_optional_time");
            ...
            logger.error("İndeks oluşturulurken hata: {}", e.getMessage(), e);
    ...
    public void indexRateData(RateData rateData) {
        try {
            ...
            // ID oluştur
            String id = rateData.getRateName() + "_" + System.currentTimeMillis();
            ...
            logger.info("Rate verisi indekslendi: {}", rateData.getRateName());
        } catch (IOException e) {
